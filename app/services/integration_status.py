...
def build_integration_status(
    ...
    aws_credentials = _aws_credentials_status()
    model = _model_status()
...
def _aws_credentials_status() -> dict[str, Any]:
    ...
    configured = env_key_pair or profile or web_identity or container_role or shared_files
    sources = [
        name
        for name, enabled in {
