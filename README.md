...
exact cache와 semantic cache의 적중률을 확인합니다. Redis URL을 AWS ElastiCache Redis 엔드포인트로 설정하면 같은 Redis 프로토콜로 연결할 수 있습니다.

응답 예시:

```json
{
  "exact_cache_backend": "redis_or_elasticache",
